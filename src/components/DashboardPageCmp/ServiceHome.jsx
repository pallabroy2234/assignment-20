...
const ServiceHome = ({ service }) => {
  ...
  const submit = async (e) => {
    ...
    let res = await axios.post("/api/dashboard/service/create", {
      title,
      imgCDN,
    });
              ...
              <div className="grid gap-5">
                ...
                <div>
                  ...
                  <input
                    ...
                    autoComplete="given-name"
                    className="service w-full p-3 mt-2 text-gray-700 bg-gray-200 appearance-none focus:outline-none focus:bg-gray-300 focus:shadow-inner"
                    required=""
                  />
                </div>
              </div>
